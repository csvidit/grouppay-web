    ...
    <LayoutGroup>
      <motion.header layout layoutRoot className="fixed top-4 lg:top-6 z-40 self-center w-full lg:flex lg:flex-col">
        <motion.div
          ...
          className="rounded-md justify-center max-w-full self-center px-8 py-2 mx-4 lg:mx-6 flex flex-col gap-2 bg-neutral-950 bg-opacity-60 border border-neutral-800 backdrop-blur-md"
        >
          <motion.div
            layout
